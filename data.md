...
*Structure to be built out in Phase 3. The example below shows the intended
shape of an entry.*

<div class="dataset">
  <h3>Example dataset</h3>
  <p class="meta">Monthly · 1900–2025 · updated 2026-01-15 · CSV</p>
  <p>One or two sentences on what the series is, how it is constructed, and
